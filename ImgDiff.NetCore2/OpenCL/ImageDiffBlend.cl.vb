...
Public Class ImageDiffBlend
    ...
    Sub New()
        ...
        Using sr As New StreamReader([GetType].GetTypeInfo.Assembly.GetManifestResourceStream("ImgDiff.NetCore2.ImageDiffBlend.cl"), Encoding.UTF8)
    ...
    Public Function NoHardwareAcceleration(imageA As Bitmap, imageB As Bitmap) As Bitmap Implements IImageProc.NoHardwareAcceleration
        ...
        ' 调用
        NoOpenCL.ImageComparer.Compare(imageAData.Height * imageAData.Stride, imageAData.Scan0, imageBData.Scan0, imageCData.Scan0)
