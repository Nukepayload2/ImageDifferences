...
Public Class ImageDiffBlend
    ...
    Sub New()
        ...
        Using sr As New StreamReader([GetType].GetTypeInfo.Assembly.GetManifestResourceStream("ImgDiff.Win32.ImageDiffBlend.cl"), Encoding.UTF8)
    ...
    ''' </summary>
    Public Function Invoke(imageA As Bitmap, imageB As Bitmap) As Bitmap
        ' A
